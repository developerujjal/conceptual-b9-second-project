...
const Products = () => {
    return (
        ...
        <h2 className="text-4xl font-extrabold text-gray-800 mb-12">Glasses</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-gray-800">Golden Glass Wear</h3>
              <div className="flex items-center justify-between mt-6">
                ...
                <h4 className="text-lg text-gray-800 font-bold">$10.5</h4>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-gray-800">Blue Glass Wear</h3>
              <div className="flex items-center justify-between mt-6">
                <div
                  className="w-10 h-10  bg-gray-100 flex items-center justify-center rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18px" className="fill-gray-800 inline-block" viewBox="0 0 64 64">
                ...
                <h4 className="text-lg text-gray-800 font-bold">$9</h4>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-gray-800">Black Glass Wear</h3>
              <div className="flex items-center justify-between mt-6">
                <div
                  className="w-10 h-10  bg-gray-100 flex items-center justify-center rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18px" className="fill-gray-800 inline-block" viewBox="0 0 64 64">
                ...
                <h4 className="text-lg text-gray-800 font-bold">$16</h4>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-gray-800">Round Glass</h3>
              <div className="flex items-center justify-between mt-6">
                <div
                  className="w-10 h-10  bg-gray-100 flex items-center justify-center rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18px" className="fill-gray-800 inline-block" viewBox="0 0 64 64">
                ...
                <h4 className="text-lg text-gray-800 font-bold">$14</h4>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-gray-800">White Lens Glass</h3>
              <div className="flex items-center justify-between mt-6">
                <div
                  className="w-10 h-10  bg-gray-100 flex items-center justify-center rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18px" className="fill-gray-800 inline-block" viewBox="0 0 64 64">
                ...
                <h4 className="text-lg text-gray-800 font-bold">$8</h4>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-gray-800">Black Glass</h3>
              <div className="flex items-center justify-between mt-6">
                <div
                  className="w-10 h-10  bg-gray-100 flex items-center justify-center rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18px" className="fill-gray-800 inline-block" viewBox="0 0 64 64">
                ...
                <h4 className="text-lg text-gray-800 font-bold">$11.5</h4>
              </div>
            </div>
          </div>
        </div>
